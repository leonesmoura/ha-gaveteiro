...
def status(request: Request):
    ...
    return AuthStatus(authenticated=user is not None, via_ingress=via_ingress, username=user)
...
def login(payload: LoginIn, response: Response):
    ...
    return AuthStatus(authenticated=True, via_ingress=False, username=payload.username)
